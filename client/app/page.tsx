    ...
    <div className={`min-h-screen ${themeClasses}`}>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <SignedOut>
                <Link
                  href="/sign-in"
                  className="inline-block px-4 py-2.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition"
                >
                  Sign In
                </Link>
              </SignedOut>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-16">
            {languages.map((lang) => (
              <div
                key={lang.name}
                className={`${cardClasses} px-4 py-2 rounded-full border flex items-center space-x-2 transition-all duration-200 ${isDarkMode ? "hover:bg-gray-700 hover:border-gray-600" : "hover:bg-gray-100 hover:border-gray-400"
                  }`}
              >
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose CodeSandbox?</h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="p-0">
                ...
                <h3 className={`text-xl font-semibold mb-3 ${isDarkMode ? "text-gray-400" : "text-gray-800"}`}>
                  {feature.title}
                </h3>
      ...
      <section className={`py-20 ${isDarkMode ? "bg-gray-800" : "bg-gray-100"}`}>
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div
                className={`px-4 py-3 border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"} flex items-center space-x-2`}
              >
